...
const VARIANT_TYPES = ["Yellow Gold", "White Gold", "Rose Gold", "Silver", "Platinum"];
...
if (!response.ok) throw new Error(resData.message || "Failed to add product");
...
<div className="border border-amber-300 rounded-xl p-4 bg-amber-50 mb-8">
  ...
  >
    ➕ Add Variant
          ...
          {/* Product Video (MP4) */}
<div>
  <label className="block text-sm font-medium">Product Video (MP4)</label>
  <input
    type="file"
    accept="video/mp4"
    onChange={(e) => {
  ...
  <div>
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select name="metalType" value={formData.metalType} onChange={handleChange} className="w-full px-4 py-3 border-2 rounded-xl focus:border-yellow-500">
            ...
            <div>
              ...
              <select name="stoneType" value={formData.stoneType} onChange={handleChange} className="w-full px-4 py-3 border-2 rounded-xl focus:border-yellow-500">
            ...
            <div>
              ...
              <select name="style" value={formData.style} onChange={handleChange} className="w-full px-4 py-3 border-2 rounded-xl focus:border-yellow-500">
            ...
            <div>
              ...
              <input type="text" name="size" value={formData.size} onChange={handleChange} placeholder="e.g., 6, 7, 16 inch" className="w-full px-4 py-3 border-2 rounded-xl focus:border-yellow-500" />
            </div>

            {/* Color */}
            <div>
              <label className="block text-sm font-medium">Color</label>
              <input type="text" name="color" value={formData.color} onChange={handleChange} placeholder="e.g., Rose Gold, D-Color, Blue" className="w-full px-4 py-3 border-2 rounded-xl focus:border-yellow-500" />
            </div>
          </div>
...
<div>
  ...
  {/* Making Charges */}
  <div>
    <label htmlFor="makingCharges" className="block text-sm font-medium">
      Making Charges
    </label>
    <input
      id="makingCharges"
  ...
  <div>
    ...
    />
          ...
          <div>
            <h3 className="text-lg font-semibold mb-3">Prices for Other Currencies</h3>
...
<div className="mt-8">
  ...
  {/* Stone Details */}
  <div>
    <label htmlFor="stoneDetails" className="block text-sm font-medium">
      Stone Details
    </label>
    <input
      id="stoneDetails"
